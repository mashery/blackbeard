...
var renderDocsNote = function () {
	...
	if (!note) return;
	note.innerHTML = '<p><em><strong>HEADS UP!</strong> The template and initialization for this plugin are included in the initialization code generated by the <a href="/docs/read/customizing/download">Theme Customizer</a>. You only need to use this documentation if you want to make modifications.</em></p>';
};
